...
// v4: 'Contratado' ya no es "ingreso a la obra" sino "proceso completo,
// falta firmar contrato en oficina JAO" -- mensaje distinto al de
// 'EPP_listo' (acceso físico a la obra una vez que el EPP está listo).
$mensaje = null;
if ($autorizado) {
